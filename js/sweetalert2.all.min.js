! function(t, e) { "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t = t || self).Sweetalert2 = e() }(this, function() { "use strict";
    ...
    function q() { var t = h(Z().querySelectorAll('[tabindex]:not([tabindex="-1"]):not([tabindex="0"])')).sort(function(t, e) { return t = parseInt(t.getAttribute("tabindex")), (e = parseInt(e.getAttribute("tabindex"))) < t ? 1 : t < e ? -1 : 0 }),
    ...
    function xt(t, e) { t.placeholder && !e.inputPlaceholder || (t.placeholder = e.inputPlaceholder) } var Pt = { promise: new WeakMap, innerParams: new WeakMap, domCache: new WeakMap },
        ...
        Et = function(t) { if (!Tt[t.input]) return U('Unexpected type of input! Expected "text", "email", "password", "number", "tel", "select", "radio", "checkbox", "textarea", "file" or "url", got "'.concat(t.input, '"')); var e = Ot(t.input),
                n = Tt[t.input](e, t);
            et(n), setTimeout(function() { X(n) }) },
        Bt = function(t, e) { var n = J(k(), t); if (n)
        ...
        St = function(t) { var e = Ot(t.input);
    ...
    function Lt(t, e) { var n, o, i, r, a, c = k().querySelector("#".concat(W.content));
        e.html ? (ut(e.html, c), et(c, "block")) : e.text ? (c.textContent = e.text, et(c, "block")) : nt(c), n = t, o = e, i = k(), r = Pt.innerParams.get(n), a = !r || o.input !== r.input, At.forEach(function(t) { var e = W[t],
                n = mt(i, e);
            Bt(t, o.inputAttributes), n.className = e, a && nt(n) }), o.input && (a && Et(o), St(o)), H(k(), e, "content") }

    function jt() { return Y() && Y().getAttribute("data-queue-step") }

    function qt(t, s) { var u = P(); if (!s.progressSteps || 0 === s.progressSteps.length) return nt(u), 0;
        et(u), u.textContent = ""; var l = parseInt(void 0 === s.currentProgressStep ? jt() : s.currentProgressStep);
    ...
    function It(t, e) { var n, o, i, r, a, c, s, u, l = O();
        H(l, e, "header"), qt(0, e), n = t, o = e, (r = Pt.innerParams.get(n)) && o.icon === r.icon && w() ? H(w(), o, "icon") : (Rt(), o.icon && (-1 !== Object.keys(K).indexOf(o.icon) ? (i = y(".".concat(W.icon, ".").concat(K[o.icon])), et(i), Dt(i, o), Ht(), H(i, o, "icon"), pt(i, o.showClass.icon)) : U('Unknown icon! Expected "success", "error", "warning", "info" or "question", got "'.concat(o.icon, '"')))),
            function(t) { var e = x(); if (!t.imageUrl) return nt(e);
                et(e, ""), e.setAttribute("src", t.imageUrl), e.setAttribute("alt", t.imageAlt), tt(e, "width", t.imageWidth), tt(e, "height", t.imageHeight), e.className = W.image, H(e, t, "image") }(e), a = e, c = C(), ot(c, a.title || a.titleText), a.title && ut(a.title, c), a.titleText && (c.innerText = a.titleText), H(c, a, "title"), s = e, u = j(), V(u, s.closeButtonHtml), H(u, s, "closeButton"), ot(u, s.showCloseButton), u.setAttribute("aria-label", s.closeButtonAriaLabel) }
    ...
    function Vt() { return E() && E().click() } var Rt = function() { for (var t = n(), e = 0; e < t.length; e++) nt(t[e]) },
    ...
    function be(t) { var e = Y(),
            n = Z(); "function" == typeof t.onBeforeOpen && t.onBeforeOpen(n), Oe(e, n, t), Be(e, n), I() && Se(e, t.scrollbarPadding), Q() || $t.previousActiveElement || ($t.previousActiveElement = document.activeElement), "function" == typeof t.onOpen && setTimeout(function() { return t.onOpen(n) }), ft(e, W["no-transition"]) }
    ...
    function Ae(t, e, n) { var o = q(),
            i = 0; if (i < o.length) return (e += n) === o.length ? e = 0 : -1 === e && (e = o.length - 1), o[e].focus();
        Z().focus() }

    function Ee(t, e, n) { Pt.innerParams.get(t).toast ? Ke(t, e, n) : (Ze(e), Qe(e), $e(t, e, n)) } var Be = function(t, e) { wt && rt(e) ? (t.style.overflowY = "hidden", e.addEventListener(wt, ye)) : t.style.overflowY = "auto" },
        Se = function(t, e) { var n;
        ...
        Ie = function(e, n) { var o = e.getInput();
        ...
        Me = { select: function(t, e, i) {
                function r(t, e, n) { var o = document.createElement("option");
                    o.value = n, V(o, e), i.inputValue.toString() === n.toString() && (o.selected = !0), t.appendChild(o) } var a = mt(t, W.select);
                e.forEach(function(t) { var e, n = t[0],
                        o = t[1];
                    Array.isArray(o) ? ((e = document.createElement("optgroup")).label = n, e.disabled = !1, a.appendChild(e), o.forEach(function(t) { return r(e, t[1], t[0]) })) : r(a, o, n) }), a.focus() }, radio: function(t, e, a) { var c = mt(t, W.radio);
        ...
        _e = function(t, e, n) { if (!e.isComposing && e.target && t.getInput() && e.target.outerHTML === t.getInput().outerHTML) { if (-1 !== ["textarea", "file"].indexOf(n.input)) return;
                Vt(), e.preventDefault() } },
        Fe = function(t) { for (var e = t.target, n = q(), o = -1, i = 0; i < n.length; i++)
                if (e === n[i]) { o = i; break }
        ...
        nn = Object.freeze({ hideLoading: ne, disableLoading: ne, getInput: function(t) { var e = Pt.innerParams.get(t || this),
                ...
                ve(e), Object.freeze(e), $t.timeout && ($t.timeout.stop(), delete $t.timeout), clearTimeout($t.restoreFocusTimeout); var n = function(t) { var e = { popup: Z(), container: Y(), content: k(), actions: S(), confirmButton: E(), cancelButton: B(), closeButton: j(), validationMessage: A(), progressSteps: P() }; return Pt.domCache.set(t, e), e }(this); return Mt(this, e), Pt.innerParams.set(this, e),
    ...
    s(on.prototype, nn), s(on, ee), Object.keys(nn).forEach(function(t) { on[t] = function() { if (tn) return tn[t].apply(tn, arguments) } }), on.DismissReason = z, on.version = "9.14.0"; var rn = on; return rn.default = rn }), void 0 !== this && this.Sweetalert2 && (this.swal = this.sweetAlert = this.Swal = this.SweetAlert = this.Sweetalert2);
